...
<head>
    ...
    <link rel="stylesheet" href="/front_app/pegasusrises.css?v=1453077469796">
    <!-- Favicon-->
                    ...
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            ...
                            <p class="animated4">
                                ...
                                <a href="" class="slider btn btn-primary" signup-modal="">Sign up now</a><!-- visible-sm visible-xs-->
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <!--<div class="hidden col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="05">-->
                    <!--<div class="team-member modern">-->
                        ...
                        <!--<div class="progress">-->
                            ...
                            <!--</div>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; Start Progress Bar 2 &ndash;&gt;-->
                        ...
                        <!--<div class="progress">-->
                            ...
                            <!--</div>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; Start Progress Bar 3 &ndash;&gt;-->
                        ...
                        <!--<div class="progress">-->
                            ...
                            <!--</div>-->
                        <!--</div>-->
                        <!--&lt;!&ndash; Member Social Links &ndash;&gt;-->
...
<script  src="/front_app/scripts.js?v=1453077469796"></script>
<script  src="/front_app/pegasusrises.js?v=1453077469796"></script>
<script src="/front_app/templates/app.js?v=1453077469796"></script>
<script src="/front_app/templates/common.js?v=1453077469796"></script>
