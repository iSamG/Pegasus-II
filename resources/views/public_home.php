...
<!--[if !IE]><!--> <html lang="en" ><!--<![endif]--><!--manifest="/punters/b2w_public.appcache"-->
<head>
    <meta charset="utf-8">
    <title>i-Bid2win | Where the highest bidder wins</title>
    <!--[if IE]> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <![endif]-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="i-Bid2Win is an online auction bidding platform" name="description" />
    <meta content="PollAfrique Ltd" name="author" />

    <meta property="og:title"
          content="Where the highest bidder wins" />

    <meta property="og:site_name"
          content="i-Bid2Win" />

    <meta property="og:url"
          content="http://www.i-bid2win.com" />

    <meta property="og:description" content="i-Bid2Win is an online, TV, and mobile based bidding auction game with a target audience
	for participation anticipated to be corporate workers, social work groups & association’s members, families, students, and individuals with an age range between 18-55.
	It was borne out of the realization that most if not all SMS based competitions are not interactive enough in terms of a more dynamic offering."/>

    <meta property="fb:app_id" content="384423575082172" />
...
<div id="container">
    ...
    <div class="hidden section service">
        <div class="container">
            <div class="row">
    ...
    <div class="hidden section purchase">
        <div class="container">
    ...
    <div class="hidden section full-width-portfolio" style="border-top:0; border-bottom:0; background:#fff;">
    ...
    <div class="section hidden" style="background:#fff;">
        <div class="container">
    ...
    <div class="hidden section pricing-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <!-- Start Big Heading -->
