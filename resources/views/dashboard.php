...
<div class="wrapper">
    ...
    <div class="header_bar">
        ...
        <div class="brand">
            ...
            <div class="logo" style="display:block">
                <a href="/">
                    <img alt="Bissame" style="width: 60%" src="front_app/assets/images/bissame.png">
                </a>
                <!--<span class="blue_text">Bissame</span>-->
            </div>
        </div>
        <!--\\\\\\\ brand end \\\\\\-->
        <div class="header_top_bar">
            ...
            <div class="top_left">
                <div class="top_left_menu">
                    <ul>
                        <li> <a href="javascript:void(0);"><i class="fa fa-refresh" ng-class="{'fa-spin' : loading }"></i></a> </li>
                    </ul>
                </div>
            </div>

            <a href="javascript:void(0);" class="add_server hidden" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus-square"></i>
                <span> New Server</span> </a>
                    ...
                    <div class="top_right_menu">
                        <ul>
                            ...
                            <li class="dropdown"> <a href="javascript:void(0);" data-toggle="dropdown"> Notifications
                                <span class="badge badge color_1 hidden">4</span> </a>
                                <ul class="drop_down_task dropdown-menu">
                                    <div class="top_pointer"></div>
                                    <li>
                                        <p class="number"></p>
                                    </li>
                                    <li> <a href="readmail.html" class="mail">
                                        <span class="subject">
                                            <!--<span class="from">sarat m</span>-->
                                            <span class="time"></span>
                                        </span> <span class="message">You have no notifications</span>
                                    </a>
                                    </li>
                            ...
                            <li class="dropdown hidden"> <a href="javascript:void(0);" data-toggle="dropdown"> Quick Menu </a>
    ...
    <div class="inner">
        ...
        <div class="left_nav_slidebar">
            <ul>
                <li class="theme_border" ng-class="{'left_nav_active' : $state.includes('home')}">
                    <a ui-sref="home"><i class="fa fa-home"></i> HOME <span class="left_nav_pointer">
                ...
                <li class="theme_border" ng-class="{'left_nav_active' : $state.includes('surveys')}">
                    <a class="pointer"> <i class="fa fa-list"></i> SURVEYS <span class="plus"><i class="fa fa-plus"></i></span></a>
                    <ul>
                        <li> <a ui-sref="surveys"> <span>&nbsp;</span> <i class="fa fa-list"></i> <b>List Surveys</b> </a> </li>
                        <li> <a ui-sref="surveys.respondents"> <span>&nbsp;</span> <i class="fa fa-users"></i> <b>Invite Respondents</b> </a> </li>
                        <li class="hidden"> <a href=""> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Questionnaires</b> </a> </li>
                        <li class="hidden"> <a href=""> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Statistics</b> </a> </li>
                    </ul>
                </li>
                ...
                <li class="hidden"> <a href="javascript:void(0);"> <i class="fa fa-glass"></i> EXTRA <span class="plus"><i class="fa fa-plus"></i></span></a>
                    <ul>
                        <li> <a href=""> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Timeline</b> </a> </li>
                        <li> <a href=""> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Profile</b> </a> </li>
                        <li> <a href=""> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Contact List</b> </a> </li>
                        <li> <a href=""> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Maps</b> </a> </li>
                        <li> <a href=""> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Gallery</b> </a> </li>
                        <li> <a href=""> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Help</b> </a> </li>
                    </ul>
                </li>
            </ul>
        </div>
