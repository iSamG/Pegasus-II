...
@param {Number} [startIndex=0] If non-zero and _thing_ is an array or array-like
  collection, a subset of item starting at the specified index will be
  returned.
...
value from the function will stop the processing of remaining item.
...
@return {Boolean} `true` if the function returns a truthy value on any of the
  item in the array; `false` otherwise.
@static
**/
...
/**
 * A simple FIFO queue.  Items are added to the Queue with add(1..n item) and
 * removed using next().
 *
 * @class Queue
 * @constructor
 * @param {MIXED} item* 0..n item to seed the queue.
 */
function Queue() {
    this._init();
...
Queue.prototype = {
    ...
    _init: function() {
        /**
         * The collection of enqueued item
         *
         * @property _q
         * @type Array
         * @protected
    ...
    /**
     * Add 0..n item to the end of the queue.
     *
     * @method add
     * @param {MIXED} item* 0..n item.
    ...
    /**
     * Returns the current number of queued item.
     *
     * @method size
...
// Add rollup file, need to add to supersedes list too
    ...
    /**
    * Grab all the item that were asked for, check to see if the Loader
    ...
    */
    ...
    _sort: function() {
        ...
        for (;;) {
            ...
            // start the loop after item that are already sorted
            for (j = p; j < l; j++) {
    ...
    */
    ...
    /**
    * Once a loader operation is completely finished, process any additional queued item.
    * @method _continue
    * @private
    */
    _continue: function() {
