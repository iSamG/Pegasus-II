...
(function( $, undefined ) {
	...
	$.mobile._registerInternalEvents = function() {
		...
		$.mobile.document.bind( "vclick", function( event ) {
			...
			// List item have the button data in the parent of the element clicked
...
$.widget( "mobile.selectmenu", $.extend( {
	...
	// setup item that are generally necessary for select menu extension
...
// array.
//
// Returns: An object containing the following item:
//
...
$.widget( "mobile.filterable", {
	...
	_filterItems: function( val ) {
		...
		if ( val != null ) {
			...
			// Partition the item into those to be hidden and those to be shown
		...
		// If nothing is hidden, then the decision whether to hide or show the item
