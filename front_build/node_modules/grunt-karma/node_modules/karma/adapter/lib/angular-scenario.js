 ...
 *     item to the array at the begging (shift) instead of at the end (push)
 *
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    Scope.prototype = {
       ...
       * (for arrays this implies watching the array item, for object maps this implies watching the properties).
       * If a change is detected the `listener` callback is fired.
       *
       * - The `obj` collection is observed via standard $watch operation and is examined on every call to $digest() to
       *   see if any item have been added, removed, or moved.
       * - The `listener` is called whenever anything within the `obj` has changed. Examples include adding new item
       *   into the object or array, removing and moving item around.
       *
       *
       * # Example
       * <pre>
