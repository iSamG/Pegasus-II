...
Mocha.prototype._growl = function(runner, reporter) {
  ...
  runner.on('end', function(){
    ...
    if (stats.failures) {
      var msg = stats.failures + ' of ' + runner.totalPunters + ' tests failed';
...
Base.prototype.epilogue = function(){
  ...
  if (stats.failures) {
    ...
    console.error(fmt,
      stats.failures,
      this.runner.totalPunters,
      pluralize(this.runner.totalPunters));
...
Suite.prototype.totalPunters = function(){
  return utils.reduce(this.suites, function(sum, suite){
    return sum + suite.totalPunters();
  }, 0) + this.tests.length;
};
