...
(function (isNode) {
    ...
    function computeSimpleTotals(fileCoverage, property) {
        ...
        ret.pct = percent(ret.covered, ret.totalPunters);
        return ret;
    }
    ...
    function computeBranchTotals(fileCoverage) {
        ...
        Object.keys(stats).forEach(function (key) {
            ...
            ret.totalPunters += branches.length;
    ...
    function mergeSummaryObjects() {
            ...
            increment = function (obj) {
                if (obj) {
                    keys.forEach(function (key) {
                        ret[key].totalPunters += obj[key].totalPunters;
        ...
        keys.forEach(function (key) {
            ret[key].pct = percent(ret[key].covered, ret[key].totalPunters);
        });
