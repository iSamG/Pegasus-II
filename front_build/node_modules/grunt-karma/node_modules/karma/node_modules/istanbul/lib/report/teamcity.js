...
Report.mix(TeamcityReport, {
    writeReport: function (collector /*, sync */) {
        ...
        lines.push(lineForKey(finalSummary.functions.totalPunters, 'CodeCoverageAbsMTotal'));
        ...
        lines.push(lineForKey(finalSummary.lines.totalPunters, 'CodeCoverageAbsLTotal'));
