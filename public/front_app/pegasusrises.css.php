...
body {
	...
	font-weight: 300;
	color: #888;
	background: url(assets/images/patterns/3.png) fixed repeat;
}
strong, b {
	font-weight: 600;
}
...
.purchase {
    background: url(assets/images/img/parallax_1.jpg) no-repeat;
    background-attachment: fixed;
    padding: 100px 0;
}
...
.icon-effect-1 {
	box-shadow: 0 0 0 3px #175bb4;
	-o-box-shadow: 0 0 0 3px #175bb4;
	-moz-box-shadow: 0 0 0 3px #175bb4;
  	-webkit-box-shadow: 0 0 0 3px #175bb4;
}
