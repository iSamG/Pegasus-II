...
OpenLayers.Control.NavigationHistory = OpenLayers.Class(OpenLayers.Control, {
    ...
    /**
     * APIProperty: limit
     * {Integer} Optional limit on the number of history item to retain.  If
    ...
    /**
     * Property: nextStack
     * {Array} Array of item in the history.
     */
    nextStack: null,

    /**
     * Property: previousStack
     * {Array} List of item in the history.  First item represents the current
     *     state.
     */
    previousStack: null,
     ...
     * Restore the previous state.  If no item are in the previous history
     *     stack, this has no effect.
     *
     * Returns:
     * {Object} Item representing state that was restored.  Undefined if no
     *     item are in the previous history stack.
     */
