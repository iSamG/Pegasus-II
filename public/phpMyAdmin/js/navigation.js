...
$(function () {
    ...
    /** Display a dialog to choose hidden navigation item to show */
...
/**
 * Loads child item of a node and executes a given callback
 *
 * @param $expandElem expander
 * @param callback    callback function
 *
 ...
 *                            of the item in a branch of the navigation tree
 */
var PMA_fastFilter = {
    /**
    ...
    events: {
        ...
        keyup: function (event) {
            ...
            // this is the div that houses the item to be filtered by this filter.
            var outerContainer;
            ...
            // filters item that are directly under the div as well as grouped in
            // groups. Does not filter child item (i.e. a database search does
            // not filter tables)
