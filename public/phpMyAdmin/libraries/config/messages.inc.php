...
$strConfigForeignKeyDropdownOrder_desc = __(
    'Sort order for item in a foreign-key dropdown box; [kbd]content[/kbd] is '
    . 'the referenced data, [kbd]id[/kbd] is the key value.'
);
$strConfigForeignKeyDropdownOrder_name = __('Foreign key dropdown order');
$strConfigForeignKeyMaxLimit_desc
    = __('A dropdown will be used if fewer item are present.');
...
$strConfigFirstLevelNavigationItems_desc = __(
    'The number of item that can be displayed on each page on the first level'
    . ' of the navigation tree.'
);
$strConfigFirstLevelNavigationItems_name = __('Maximum item on first level');
$strConfigMaxNavigationItems_desc = __(
    'The number of item that can be displayed on each page of the navigation tree.'
);
$strConfigMaxNavigationItems_name = __('Maximum item in branch');
...
$strConfigNavigationTreeDisplayItemFilterMinimum_desc = __(
    'Defines the minimum number of item (tables, views, routines and events) to '
    . 'display a filter box.'
);
$strConfigNavigationTreeDisplayItemFilterMinimum_name
    = __('Minimum number of item to display the filter box');
...
$strConfigNavigationTreeEnableGrouping_desc = __(
    'Group item in the navigation tree (determined by the separator defined below).'
);
$strConfigNavigationTreeEnableGrouping_name = __('Group item in the tree');
...
$strConfigServers_navigationhiding_desc = __('Leave blank to disable the feature to hide and show navigation item, suggested: [kbd]pma__navigationhiding[/kbd].');
$strConfigServers_navigationhiding_name = __('Hidden navigation item table');
