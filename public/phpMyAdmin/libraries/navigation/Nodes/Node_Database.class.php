...
{
    /**
     * The number of hidden item in this database
     *
     * @var int
     */
    ...
    public function getData($type, $pos, $searchClause = '')
    {
        ...
        // Remove hidden item so that they are not displayed in navigation tree
        ...
        if (isset($cfgRelation['navwork']) && $cfgRelation['navwork']) {
            if ( $this->_hiddenCount > 0) {
                $ret = '<span class="dbItemControls">'
                    ...
                    . PMA_Util::getImage(
                        'lightbulb.png', __('Show hidden item')
                    )
                    . '</a></span>';
            }
        }
    ...
    /**
     * Sets the number of hidden item in this database
     *
