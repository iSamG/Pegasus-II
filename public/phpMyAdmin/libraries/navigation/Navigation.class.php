...
class PMA_Navigation
{
    ...
    /**
     * Add an item of navigation tree to the hidden item list in PMA database.
     *
     ...
     * list of hidden item in PMA database.
     *
     * @param string $itemName  name of the navigation tree item
     * @param string $itemType  type of the navigation tree item
     * @param string $dbName    database name
    ...
    /**
     * Returns HTML for the dialog to show hidden navigation item.
     *
     * @param string $dbName    database name
     * @param string $itemType  type of the item to include
     * @param string $tableName table name
     *
     * @return string HTML for the dialog to show hidden navigation item
     */
