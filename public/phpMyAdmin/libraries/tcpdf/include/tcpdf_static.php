...
class TCPDF_STATIC {
	...
	* @since 5.9.121 (2011-09-28)
	...
	public static function getAnnotOptFromJSProp($prop, &$spot_colors, $rtl=false) {
		...
		// Sort: If set, the field's option item shall be sorted alphabetically.
		...
		// multipleSelection: If true, indicates that a list box allows a multiple selection of item.
