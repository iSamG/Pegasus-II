...
class ExportSql extends ExportPlugin
{
    ...
    protected function setProperties()
    {
        ...
        if (! $hide_sql) {
            ...
            include_once "$props/options/item/MessageOnlyPropertyItem.class.php";
            include_once "$props/options/item/RadioPropertyItem.class.php";
            include_once "$props/options/item/SelectPropertyItem.class.php";
            include_once "$props/options/item/TextPropertyItem.class.php";
            include_once "$props/options/item/NumberPropertyItem.class.php";
